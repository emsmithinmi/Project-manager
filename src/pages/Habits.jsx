...
function HabitCard({ habit, dateMap, history, onClick }) {
  ...
  return (
    ...
    >
      ...
      {/* Streak */}
      <div className="mb-3">
        <p className="text-2xl font-bold" style={{ color: '#89b4fa' }}>{streak}</p>
        <p className="text-xs" style={{ color: '#6c7086' }}>day streak</p>
      </div>
      ...
      <div className="flex items-center gap-2">
        ...
        <span className="text-xs w-8 text-right" style={{ color: '#6c7086' }}>{percent}%</span>
      </div>
    </div>
  )
}
    ...
    <div className="h-full flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto px-6 py-5">
        {loading ? (
          ...
          <>
            <p className="text-xs mb-4" style={{ color: '#6c7086' }}>
